  ...
  return (
    ...
    >
      <header className="mb-8 text-center">
        ...
        <h1 className="mb-3 text-3xl font-semibold tracking-tight text-dream-900 md:text-4xl">꽃잎점</h1>
        <p className="text-pretty text-sm leading-relaxed text-dream-700 md:text-base">
          질문을 적어도 되고, 비워 둬도 괜찮아요. <br/>
          꽃을 고른 뒤 잎을 하나씩 떼면 속삭임이 바뀌고, 마지막 잎이
          오늘의 답이에요.
        </p>
      </header>
